		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 cont">
			   <div class="titulo borde sombra">
			        <h3 class="animated zoomIn tPrincipal">Nuevo hospital</h3>
			   </div>	
								...
								<div class="row">
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label>Nombre:</label>
											<input type="text" name="nomHos" class="form-control" required autofocus placeholder="Escribe un nuevo nombre de hospital">
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label>Dirección:</label>
											<input type="text" name="dir" class="form-control" required autofocus placeholder="Escribe una nueva dirección de hospital">
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label>Teléfono:</label>
											<input type="text" name="tel" class="form-control" required autofocus placeholder="Escribe un nuevo teléfono de hospital">
										</div>
									</div>
								</div>
							</div>
