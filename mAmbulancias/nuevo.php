		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 cont">
			   <div class="titulo borde sombra">
			        <h3 class="animated zoomIn tPrincipal">Nueva ambulancia</h3>
			   </div>	
								...
								<div class="row">
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											...
											<input type="text" name="numAmb" class="form-control" required autofocus placeholder="Escribe un nuevo número de ambulancia">
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label>Modelo ambulancia:</label>
											<input type="text" name="modAmb" class="form-control" required autofocus placeholder="Escribe un nuevo modelo de ambulancia">
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
											<label>Descripción ambulancia:</label>
											<input type="text" name="descAmb" class="form-control" required autofocus placeholder="Escribe una nueva descripción de ambulancia">
										</div>
									</div>
								</div>
							</div>
