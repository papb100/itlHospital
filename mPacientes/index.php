		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 cont">
			   <div class="titulo borde sombra">
			        <h3 class="animated zoomIn tPrincipal">Lista de Pacientes</h3>
			   </div>	
					...
					<div class="table-responsive">
						<table id="example1" class="table table-responsive table-condensed table-bordered table-hover">
							...
							while ($row=mysql_fetch_row($consulta))
							{
								...
								$activo=$row[7];
								$id=$row[0];
								$status=($row[7]==1)?"<i class='far fa-check-square fa-lg fasIco'></i>":"<i class='far fa-square fa-lg fasIco'></i>";
								$desabilita=($row[7]==0)?"desactivado":"";
							...
							?>
								<tr class="centrar">
									...
									<td>
										<p class="<?php echo $desabilita?>"><?php echo $row[4]?></p>
									</td>
									<td>
										<p class="<?php echo $desabilita?>"><?php echo $row[5]?></p>
									</td>
									<td>
										<p class="<?php echo $desabilita?>"><?php echo $row[6]?></p>
									</td>
									<td>
