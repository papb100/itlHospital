		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 cont">
			   <div class="titulo borde sombra">
			        <h3 class="animated zoomIn tPrincipal">Nuevo departamento</h3>
			   </div>	
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="form-group">
											...
											<input type="text" name="depa" class="form-control" required autofocus placeholder="Escribe un nuevo departamento">
										</div>
									</div>
								</div>
							</div>
