		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 cont">
			   <div class="titulo borde sombra">
			        <h3 class="animated zoomIn tPrincipal">Editar Religiones</h3>
			   </div>	
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
										<div class="form-group">
											...
											<input type="text" name="reli" value="<?php echo $nomReligion?>"  class="form-control" required autofocus placeholder="Escribe la religión">
										</div>										
									</div>
								</div>
							</div>
